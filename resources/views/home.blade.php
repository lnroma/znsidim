                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="hello" id="hello" value="{{ Auth::user()->hello }}" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="about_me" class="control-label col-sm-4">Обо мне</label>
                            <div class="col-sm-8">
                                <textarea name="about_me" id="about_me" class="form-control">{{trim(Auth::user()->about_me)}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="birthday" class="control-label col-sm-4">День рождения</label>
                            <div class="col-sm-8">
                                <input type="text" id='birthday' name="birthday" class="form-control" value="{{ Auth::user()->birthday}}"/>
                            </div>
                        </div>
                        <div class="form-group">
